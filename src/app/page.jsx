...
import SkillFun from "@/components/Home/SkillFun/SkillFun";
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 pt-20 pb-16 text-center">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 leading-tight">
          স্বপ্ন<span className="text-primary text-glow">চক্র</span> প্রজেক্টে
          স্বাগতম!
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            size="lg"
            className="bg-primary hover:bg-primary/90 text-white rounded-full px-8 py-6 text-lg shadow-xl shadow-primary/20 gap-2 transition-all hover:scale-105"
          >
          ...
          <Button
            size="lg"
            variant="outline"
            className="rounded-full px-8 py-6 text-lg border-primary/20 hover:bg-primary/5 gap-2"
          >
        ...
        <div className="mt-20 relative max-w-5xl mx-auto h-[300px] md:h-[500px] rounded-3xl border border-primary/20 bg-card shadow-2xl overflow-hidden flex items-center justify-center">
          ...
          <p className="text-muted-foreground italic">
            স্বপ্নচক্র ড্যাশবোর্ড প্রিভিউ (Coming Soon)
          </p>
        </div>
      </section>
    </main>
